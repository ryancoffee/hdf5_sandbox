...
LDFLAGS=-L/usr/local/lib -L/usr/local/hdf5/lib /usr/local/hdf5/lib/libhdf5_hl.a /usr/local/hdf5/lib/libhdf5.a -lz -ldl -lm -Wl,-rpath -Wl,/usr/local/lib -ldl -lpthread -lrt
